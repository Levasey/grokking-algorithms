 ...
 * <p>
 * Один экземпляр — один скетч без операции объединения ({@code union}) с другим (в промышленных библиотеках
 * регистры обычно сливаются по {@code max}). Хеш строки учебный. Структура не потокобезопасна.
 */
public final class HyperLogLog {
    ...
    /**
     * Оценка числа различных добавленных значений (округление к ближайшему {@code long}; при очень больших
     * истинных кардинальностях возможен насыщение диапазона {@code long}).
     */
