 ...
 * <p>
 * Токены — непрерывные последовательности букв/цифр в нижнем регистре; стемминг и стоп-слова не применяются.
 * Экземпляр после {@link #add} не рассчитан на параллельное изменение из нескольких потоков; {@link #buildParallel}
 * собирает снимок в один объект без дальнейшей внутренней синхронизации.
 */
