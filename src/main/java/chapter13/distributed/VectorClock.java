 ...
 * <p>
 * Не потокобезопасны: при конкуренции вокруг одного экземпляра нужна внешняя синхронизация.
 */
public final class VectorClock {
    ...
    /**
     * Снимок текущего вектора; изменения возвращённого массива не затрагивают состояние часов.
     */
    public int[] snapshot() {
