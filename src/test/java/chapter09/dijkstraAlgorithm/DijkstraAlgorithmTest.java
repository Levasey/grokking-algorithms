...
class DijkstraAlgorithmTest {
    ...
    void shortestDistancesPreferCheaperRoute() {
        ...
        DijkstraAlgorithm.calculate(graph, a);
    ...
    void rebuildsShortestPath() {
        ...
        DijkstraAlgorithm.calculate(chain, start);

        List<Node> path = DijkstraAlgorithm.getShortestPathTo(end);
    ...
    void secondRunResetsUnreachableComponent() {
        ...
        DijkstraAlgorithm.calculate(graph, x);
    ...
    void stalePreviousClearedOnDisconnectedSecondRun() {
        ...
        DijkstraAlgorithm.calculate(graph, b);
