...
public class KNearestNeighborsTest {
    ...
    public void classify_k1_nearestLabel() {
        List<KNearestNeighbors.LabeledPoint> data = List.of(
                new KNearestNeighbors.LabeledPoint(new double[]{0, 0}, "A"),
                new KNearestNeighbors.LabeledPoint(new double[]{10, 10}, "B")
        );
    ...
    public void classify_k3_majorityVotes() {
        List<KNearestNeighbors.LabeledPoint> data = List.of(
                new KNearestNeighbors.LabeledPoint(new double[]{0, 0}, "cat"),
                new KNearestNeighbors.LabeledPoint(new double[]{0, 1}, "cat"),
                new KNearestNeighbors.LabeledPoint(new double[]{5, 5}, "dog"),
                new KNearestNeighbors.LabeledPoint(new double[]{6, 6}, "dog")
        );
    ...
    public void classify_voteTie_prefersCloserNeighborOrder() {
        List<KNearestNeighbors.LabeledPoint> data = List.of(
                new KNearestNeighbors.LabeledPoint(new double[]{0, 0}, "A"),
                new KNearestNeighbors.LabeledPoint(new double[]{1.2, 0}, "B"),
                new KNearestNeighbors.LabeledPoint(new double[]{0, 10}, "A")
        );
    ...
    public void predictAverage_k2_isMeanOfTwoClosestTargets() {
        List<KNearestNeighbors.RegressionPoint> data = List.of(
                new KNearestNeighbors.RegressionPoint(new double[]{0}, 10),
                new KNearestNeighbors.RegressionPoint(new double[]{2}, 20),
                new KNearestNeighbors.RegressionPoint(new double[]{10}, 100)
        );
    ...
    public void classify_rejectsBadK() {
        List<KNearestNeighbors.LabeledPoint> one = List.of(new KNearestNeighbors.LabeledPoint(new double[]{0}, "a"));
