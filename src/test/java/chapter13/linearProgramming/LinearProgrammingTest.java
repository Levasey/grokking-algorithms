...
public class LinearProgrammingTest {
    ...
    public void maximize_classicThreeConstraints_optimalInteriorVertex() {
        ...
        LinearProgramming.Solution s = LinearProgramming.maximize(c, a, b);
        assertSame(LinearProgramming.Status.OPTIMAL, s.status());
    ...
    public void maximize_simplexUnbounded_returnsUnbounded() {
        ...
        LinearProgramming.Solution s = LinearProgramming.maximize(c, a, b);
        assertSame(LinearProgramming.Status.UNBOUNDED, s.status());
        assertNull(s.x());
    }
    ...
    public void minimize_smallProblem_matchesNegatedMax() {
        ...
        LinearProgramming.Solution s = LinearProgramming.minimize(c, a, b);
        assertSame(LinearProgramming.Status.OPTIMAL, s.status());
