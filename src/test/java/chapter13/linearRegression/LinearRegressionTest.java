...
public class LinearRegressionTest {
    ...
    public void train_perfectLine_oneFeature_recoversSlopeAndIntercept() {
        ...
        LinearRegression.FitResult fit = LinearRegression.train(x, y, 0.15, 50_000, 1e-12);
    ...
    public void train_twoFeatures_plane() {
        ...
        LinearRegression.FitResult fit = LinearRegression.train(x, y, 0.08, 100_000, 1e-10);
        double[] w = fit.weights();
    ...
    public void trainParallel_matchesTrain_oneFeature() {
        double[][] x = {{0}, {1}, {2}};
        double[] y = {2, 5, 8};
        LinearRegression.FitResult seq = LinearRegression.train(x, y, 0.15, 50_000, 1e-12);
        LinearRegression.FitResult par = LinearRegression.trainParallel(x, y, 0.15, 50_000, 1e-12);
    ...
    public void trainParallel_matchesTrain_twoFeatures() {
        ...
        double[] y = {1, 2, 3, 4, 5};
        LinearRegression.FitResult seq = LinearRegression.train(x, y, 0.08, 100_000, 1e-10);
        LinearRegression.FitResult par = LinearRegression.trainParallel(x, y, 0.08, 100_000, 1e-10);
        assertEquals(seq.iterations(), par.iterations());
        assertArrayEquals(seq.weights(), par.weights(), 1e-9);
    }
}
