...
public class KnapsackTest {
    ...
    public void maxValue_zeroCapacity_isZero() {
        List<Knapsack.Item> items = List.of(new Knapsack.Item(1, 100));
    ...
    public void maxValue_classicExampleFromBook() {
        List<Knapsack.Item> items = List.of(
                new Knapsack.Item(1, 1500),
                new Knapsack.Item(4, 3000),
                new Knapsack.Item(3, 2000),
                new Knapsack.Item(1, 2000)
        );
    ...
    public void item_rejectsNegativeWeight() {
        assertThrows(IllegalArgumentException.class, () -> new Knapsack.Item(-1, 0));
    }
}
